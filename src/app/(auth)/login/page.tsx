        ...
        <div className="relative hidden md:flex md:col-span-6 lg:col-span-7 flex-col justify-between p-8 lg:p-12 text-white bg-slate-950 overflow-hidden">
          ...
          <div className="relative z-10 flex items-center gap-2.5">
            <svg viewBox="0 0 24 24" className="h-7 w-7 text-white" fill="none">
              <path
                ...
                fill="url(#gemini-spark-auth)"
              />
              <defs>
                <linearGradient id="gemini-spark-auth" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold tracking-tight leading-tight">
              Toma el control de tus deudas y gastos
            </h1>
            <p className="text-base text-slate-200/90 leading-relaxed font-light">
              Utiliza algoritmos de amortización avanzados y recomendaciones personalizadas por Inteligencia Artificial para alcanzar tu libertad financiera en tiempo récord.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/10">
              <div className="flex gap-2.5 items-start">
                ...
                <div>
                  <h4 className="font-semibold text-sm">Seguridad de datos</h4>
                  <p className="text-xs text-slate-300">Conexión cifrada a Supabase</p>
                </div>
              </div>
              <div className="flex gap-2.5 items-start">
                <Sparkles className="h-5 w-5 text-cyan-400 shrink-0 mt-0.5" />
                <div>
                  <h4 className="font-semibold text-sm">OCR de tickets</h4>
                  <p className="text-xs text-slate-300">Sube tus tickets y extrae gastos con IA</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative w-full max-w-md space-y-8">
            ...
            <div className="flex items-center justify-center gap-2 md:hidden">
              <svg viewBox="0 0 24 24" className="h-8 w-8 animate-pulse" fill="none">
                <path
                  d="M12 2C12 2 12.5 8 15 10.5C17.5 13 22 13 22 13C22 13 16 13.5 13.5 16C11 18.5 11 22 11 22C11 22 10.5 16 8 13.5C5.5 11 2 11 2 11C2 11 8 10.5 10.5 8C13 5.5 12 2 12 2Z"
                  fill="url(#gemini-spark-auth-mob)"
                />
                <defs>
                  <linearGradient id="gemini-spark-auth-mob" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" stopColor="#3B82F6" />
                    <stop offset="35%" stopColor="#06B6D4" />
                    <stop offset="70%" stopColor="#3B82F6" />
                    <stop offset="100%" stopColor="#2563EB" />
            ...
            >
              <div className="space-y-2 mb-6">
                ...
                <p className="text-sm text-slate-500 font-light">
                  Ingresa tus credenciales para acceder a tu gestor financiero.
                </p>
              </div>
